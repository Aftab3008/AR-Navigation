...
public class ARNavController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (IsCurrentlyNavigating() && ARStateController.instance.IsLocalized() && agent.isOnNavMesh)
        {
            ...
            if (FootprintController.instance && FootprintController.instance.enabled)
            {
                FootprintController.instance.SetPositionFrom(agent.transform);
                FootprintController.instance.SetPositionTo(currentDestination.poiCollider.transform);
            }

            if (ARPathVisualizer.instance && ARPathVisualizer.instance.enabled)
            {
    ...
    public void StopNavigation()
    {
        if (currentDestination != null)
        {
            ...
            if (FootprintController.instance && FootprintController.instance.enabled)
            {
                FootprintController.instance.ResetSteps();
            }
