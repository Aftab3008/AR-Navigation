...
public class NavUIController : MonoBehaviour
{
    ...
    public GameObject pathCornerToggleParrent;
 ...
 */
    ...
    /**
     * Toggle ARPathVisualizer controller.
     */
    public void ToggleARPathVisualizer()
    {
        if (ARPathVisualizer.instance)
        {
            ARPathVisualizer.instance.gameObject.SetActive(!ARPathVisualizer.instance.gameObject.activeSelf);
            pathCornerToggleParrent.SetActive(ARPathVisualizer.instance.gameObject.activeSelf);
        }
        else
        {
            Debug.LogWarning("No ARPathVisualizer in the scene active.");
        }
    }

    /**
     * Toggle FootprintController controller.
     */
    public void ToggleFootprints()
    {
        if (FootprintController.instance)
        {
            FootprintController.instance.printer.gameObject.SetActive(!FootprintController.instance.printer.gameObject.activeSelf);
            FootprintController.instance.printer.footprints.SetActive(!FootprintController.instance.printer.footprints.activeSelf);
        }
        else
        {
            Debug.LogWarning("No FootprintController in the scene active.");
        }
