...
import { getFloorsByVenue } from "@/lib/queries/floor.queries";
...
export default async function VenueDetails({
  ...
  // Use the query function instead of a direct DB call
  const venueFloors = await getFloorsByVenue(venueId);
